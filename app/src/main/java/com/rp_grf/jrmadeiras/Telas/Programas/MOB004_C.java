...
public class MOB004_C extends AppCompatActivity {
    ...
    private void cliqueCheckBox(View view) {
        ...
        CheckBox checkboxNoturno = (CheckBox) findViewById(R.id.checkbox_noturno);
        CheckBox checkboxIfr = (CheckBox) findViewById(R.id.checkbox_ifr);
        CheckBox checkboxNaveg = (CheckBox) findViewById(R.id.checkbox_naveg);
        CheckBox checkboxDry = (CheckBox) findViewById(R.id.checkbox_dry);
        CheckBox checkboxWet = (CheckBox) findViewById(R.id.checkbox_wet);

        // Verifica se a checkbox está marcada
        checkboxNoturno.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (checked) {
        ...
        checkboxIfr.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (checked) {
                habilitarIFR(true);
            } else {
                habilitarIFR(false);
        ...
        checkboxNaveg.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (checked) {
                flag_naveg = true;
            } else {
                flag_naveg = false;
        ...
        checkboxDry.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (checked) {
                dry_wet = "DRY";
        ...
        checkboxWet.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (checked) {
                dry_wet = "WET";
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Define ação clique botão câmera
        menu.findItem(R.id.botao_camera_action_bar).setOnMenuItemClickListener(item -> {
            iniciarCamera();
            return true;
        });

        // Define ação clique botão salvar
        menu.findItem(R.id.botao_salvar_action_bar).setOnMenuItemClickListener(item -> {
            salvarAgendaTemporaria();
            Toasty.warning(this,
                    "Salvo!",
        ...
        // Define ação clique botão offline
        menu.findItem(R.id.botao_offline_action_bar).setOnMenuItemClickListener(item -> {
            Toasty.info(this,
