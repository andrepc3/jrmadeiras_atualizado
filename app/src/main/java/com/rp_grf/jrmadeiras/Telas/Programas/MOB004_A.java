...
public class MOB004_A extends AppCompatActivity {
    ...
    private void cliqueCheckBox(View view) {
        ...
        CheckBox checkboxPartida = (CheckBox) findViewById(R.id.checkbox_partida);
        CheckBox checkboxCorte = (CheckBox) findViewById(R.id.checkbox_corte);

        // Verifica se a checkbox está marcada
        checkboxPartida.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                flag_partida = true;
        ...
        checkboxCorte.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                flag_corte = true;
                habilitarCorte(true);
            } else {
